...
lssa_fg_simple: fft_krig_stripped.c uvfits.c primary_beamDEV.c cspline.c
	$(CC) $(CFLAGS) $(INCS) $(CFITSIO_INCS) $(GSL_INCS) $(LDFLAGS) -o lssa_fg_simple fft_krig_stripped.c uvfits.c primary_beamDEV.c cspline.c $(CFITSIO_LIBS) -lm -fopenmp $(GSL_LIBS) -lpal

lssa_fg_general: fft_krig_simple.c uvfits.c primary_beamDEV.c cspline.c
	$(CC) $(CFLAGS) $(INCS) $(CFITSIO_INCS) $(GSL_INCS) $(LDFLAGS) -o lssa_fg_general fft_krig_simple.c uvfits.c primary_beamDEV.c cspline.c $(CFITSIO_LIBS) -lm -fopenmp $(GSL_LIBS) -lpal
