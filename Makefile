...
fft_simple: fft_krig_stripped.c uvfits.c primary_beamDEV.c cspline.c
	$(CC) $(CFLAGS) $(INCS) $(CFITSIO_INCS) $(BLAS_INCS) $(GSL_INCS) $(LDFLAGS) -o lssa_fg_simple fft_krig_stripped.c uvfits.c primary_beamDEV.c cspline.c $(CFITSIO_LIBS) -lcfitsio -lm -fopenmp -lgsl -lgslcblas -lpal

fft_general: fft_krig_simple.c uvfits.c primary_beamDEV.c cspline.c
	$(CC) $(CFLAGS) $(INCS) $(CFITSIO_INCS) $(BLAS_INCS) $(GSL_INCS) $(LDFLAGS) -o lssa_fg_general fft_krig_simple.c uvfits.c primary_beamDEV.c cspline.c $(CFITSIO_LIBS) -lcfitsio -lm -fopenmp -lgsl -lgslcblas -lpal
